...
<head>
	...
	?>
<!-- Global site tag (gtag.js) - Google Ads: 960128865 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-960128865"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-960128865');
</script>
...
<script>
  gtag('config', 'AW-960128865/hHijCPjFvJMBEOHO6ckD', {
    'phone_conversion_number': '01245 362 121'
  });
</script>
</head>
